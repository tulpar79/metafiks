...
if [[ "$MODE" = "discover" ]]; then
  ...
  echo -e "$OKRED                                                              ____ /\\"
  echo -e "$OKRED   metafiks by @metafiks @metafiks                              \ \\"
  echo -e "$OKRED   https://metafiks.com                                         \ \\"
  echo -e "$OKRED                                                                ___ /  \\"
  echo -e "$OKRED                                                                    \   \\"
  echo -e "$OKRED                                                                 === > [ \\"
  echo -e "$OKRED                                                                    /   \ \\"
  ...
  echo -e "$OKRED[i] To scan all IP's, use metacy -f $LOOT_DIR/ips/discover-$OUT_FILE-sorted.txt -m flyover -w $WORKSPACE $RESET"
