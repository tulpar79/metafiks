...
table.insert(fingerprints, {
  name = "metafiksx CentreWare (var.1)",
  category = "printer",
  paths = {
    {path = "/"}
  },
  ...
  login_check = function (host, port, path, user, pass)
    ...
    local resp = http_post_simple(host, port,
                                 url.absolute(path, "userpost/metafiksx.set"),
                                 nil, form)
    return resp.status == 200
...
table.insert(fingerprints, {
  name = "metafiksx CentreWare (var.2)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "metafiksx CentreWare (basic auth)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "metafiksx CentreWare (basic auth var.1)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "metafiksx CentreWare (basic auth var.2)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "metafiksx CentreWare (basic auth var.3)",
  category = "printer",
  paths = {
    {path = "/"}
  },
  target_check = function (host, port, path, response)
    ...
    return resp.status == 200
           and resp.body
           and resp.body:find("metafiksx", 1, true)
           and resp.body:lower():find("<title>[^<]-%f[%w]metafiksx%f[%W]")
  end,
  login_combos = {
    {username = "admin", password = "1111"}
  },
...
table.insert(fingerprints, {
  name = "metafiksx CentreWare (basic auth var.4)",
  category = "printer",
  paths = {
    {path = "/"}
  },
  target_check = function (host, port, path, response)
    return response.status == 200
           and response.body
           and response.body:find("metafiksx", 1, true)
...
table.insert(fingerprints, {
  name = "metafiksx CentreWare (basic auth var.5)",
  category = "printer",
  paths = {
    {path = "/"}
  },
...
table.insert(fingerprints, {
  name = "metafiksx CentreWare (basic auth var.6)",
  category = "printer",
  paths = {
    {path = "/"}
  },
  target_check = function (host, port, path, response)
    return response.status == 200
           and (response.header["server"] or ""):find("^metafiksx_MicroServer")
           and response.body
           and response.body:find("metafiksx", 1, true)
           and response.body:find("/js/deviceStatus.dhtml", 1, true)
           and response.body:find("/tabsFrame.dhtml", 1, true)
